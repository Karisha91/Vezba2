...
public class Glavna {
    ...
    public static void main(String[] args) {
        ...
        UI ui = new UI();
        ui.startUI();
        //Profesor profesor1 = new Profesor("001", "Nenad", "Nenadovic", "Legenda");
        //Profesor profesor2 = new Profesor("002", "Marko", "Markovic", "Kralj");

        //Student student1 = new Student("Ivan", "Djurdjevic", "0232123123123", LocalDate.of(1992, 5,11));
        ...
        //Ispit ispit1 = new Ispit(predmet2, student1, 5, LocalDateTime.of(1991, 5, 12, 15, 33));
       //Ispit ispit3 = new Ispit(predmet1, student1, 2, LocalDateTime.of(1991, 5, 12, 15, 33));
        //Ispit ispit2 = new Ispit(predmet1, student2, 5, LocalDateTime.of(1991, 5, 12, 15, 33));
        //Ispit ispit4 = new Ispit(predmet1, student1, 1, LocalDateTime.of(1991, 5, 12, 15, 33));
       ...
       // listaIspita.add(ispit3);
        ...
        //ArrayList<Ispit> poStudentu = vj.filtrirajIspitePoStudentu(listaIspita, student1);
       // System.out.println(vj.izracunajKonacnuOcenuStudijaZaStudenta(poStudentu, 5, 5));
